...
with mysql.connector.connect(host="localhost",user="root",password="system",database="flaskblog"):
    ...
    cursor.execute("create table if not exists registration(Username varchar(50) primary key,Mobile varchar(20) unique,Address varchar(50) ,Email varchar(50) unique,Password varchar(20) unique)")
